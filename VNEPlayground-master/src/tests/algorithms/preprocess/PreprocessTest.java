package tests.algorithms.preprocess;
...
public class PreprocessTest {
    ...
    public void algorithmTest() {
        ...
        AcceptedVnrRatio acceptedVnrRatio = new AcceptedVnrRatio();
        // With preprocess
        System.out.println("/******** With preprocess! ********/");
        ...
        NetworkStack stackPreprocess = new NetworkStack(createSubstrate(), vnlist);
        ...
        System.out.println(stackPreprocess + "\n\n");
        ...
        NetworkStack stackOri = new NetworkStack(createSubstrate(), createVNDemands());

        AlgorithmParameter paramOri = new AlgorithmParameter();
        paramOri.put("PathSplitting", "False");
        String distanceOri = "-1";
        paramOri.put("distance", distanceOri);
        paramOri.put("kShortestPaths", "3");
        String overloadOri =  "False";
        paramOri.put("overload", overloadOri);



        AbstractAlgorithm algoOri = new CoordinatedMapping(paramOri);
        algoOri.setStack(stackOri);

        long startTimeOri=System.currentTimeMillis();

        algoOri.performEvaluation();

        long endTimeOri=System.currentTimeMillis();

        System.out.println(stackOri);
        */


        System.out.println(time.toString() +" preprocess without pre:"+ (endTime-startTime) + "ms");
        System.out.println(time.toString() +" preprocess:"+ (endTimePre-startTimePreprocess) + "ms");
        System.out.println(acceptedVnrRatio.toString() + "preprocess:" + acceptedVnrRatio.calculate(stackPreprocess));

        System.out.println("\n\n");


        /*
        System.out.println(time.toString() +" origin:"+ (endTimeOri-startTimeOri) + "ms");
